---
title: "Risk Maps for Fish Killing (Mass Mortality) Harmful Algal Bloom Events"
...
Variable `ROOT_DATA_PATH` must be updated to your preferred location for saving model input, fitted models, predictions, etc.
